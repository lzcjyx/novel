// Set maxTokens to 32768 on Gen Bible node
const fs = require('fs');
const dir = __dirname + '/';
...
async function main() {
  ...
  // Set max tokens to max allowed
  gb.parameters.options.maxTokens = 32768;
  console.log('maxTokens set to:', gb.parameters.options.maxTokens);
  console.log('All options:', JSON.stringify(gb.parameters.options));
