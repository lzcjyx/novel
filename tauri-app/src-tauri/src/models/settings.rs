...
pub struct AppSettings {
    ...
    pub publish_schedule_enabled: bool,
    pub publication_target_provider: String,
    pub publication_target_path: String,
    pub publication_posts_dir: String,
    pub publication_remote_name: String,
    pub publication_branch: Option<String>,
    pub publication_build_command: String,
    pub publication_commit_template: String,
    pub publication_push_enabled: bool,
    pub publication_dry_run: bool,
    pub publication_validate_build: bool,
...
impl Default for AppSettings {
    fn default() -> Self {
        Self {
            ...
            publication_target_provider: "firefly_git".into(),
            publication_target_path: String::new(),
            publication_posts_dir: "src/content/posts".into(),
            publication_remote_name: "origin".into(),
            publication_branch: None,
            publication_build_command: "pnpm build".into(),
            publication_commit_template: "publish: add {title}".into(),
            publication_push_enabled: false,
            publication_dry_run: false,
            publication_validate_build: true,
